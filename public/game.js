...
// Playing
socket.on('playingStarted',({currentPlayer:cp,currentPlayerName,trickNumber,b1FrozenPos,bidType})=>{
  setActiveAv(cp);
  ...
  if(bidType==='b1') toast('🎯 Bonus in 1 Hand — 3-player game! 10 tricks needed!',3500);
});
